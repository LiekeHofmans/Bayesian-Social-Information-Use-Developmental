...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='Z:\\fMRI Projects\\fMRI Project Mushroom Highschool\\data_collection\\taskcode\\1_mushroomTask_confidence_practice\\mushroomTask_lastrun.py',
...
dirName = _thisDir + os.sep + u'../../../raw_data/sub-%03d/scans' % (int(expInfo['participant']))
if not os.path.exists(dirName):
    os.makedirs(dirName)

# create directory to save image of .nii file to send to pp
dirName = _thisDir + os.sep + u'../../brain_pictures/sub-%03d' % (int(expInfo['participant']))
if not os.path.exists(dirName):
    os.makedirs(dirName)
