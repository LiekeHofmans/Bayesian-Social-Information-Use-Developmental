<html>
        ...
        <link href="<?php echo PATH;?>basis/css/grid.css" rel="stylesheet" type="text/css"  /><title>End - debrief</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         else location.replace('wait326688.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
        ...
        <script>dollarsT = getValue('dollarsT');</script><!-- END Element 1 Type: 19-->
        
        <!-- START Element 2 Type: 1-->
        
        <div class="col-sm-12" id="wrap2" style="display: none;"><div class="btnbox2 paddlr" style="text-align: center"><h3>Debriefing</h3><p><span style="background-color: rgba(223, 240, 216, 0);">Het dierenspel dat je net gespeeld hebt is ontworpen om te meten hoeveel je geneigd bent om naar anderen te luisteren bij het nemen van beslissingen.</span><br></p><p><br><span style="background-color: rgba(223, 240, 216, 0);">Je bonus was: <b><script>document.write(dollarsT)</script></b></span></p><p><span style="background-color: rgba(223, 240, 216, 0);"><br>Vraag nu de testleider om het spel af te sluiten.</span></p></div>
