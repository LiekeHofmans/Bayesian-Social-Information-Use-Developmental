<html>
        ...
        <link href="<?php echo PATH;?>basis/css/grid.css" rel="stylesheet" type="text/css"  /><title>instructions R1</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage326672.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait326671.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
        ...
        <div class="col-sm-12" id="wrap1" style="display: none;"><div class="btnbox2 paddlr" style="text-align: center"><h3>Instructies 1 van 3</h3><p></p><p>Deze taak bestaat uit <b>5 rondes</b>.<br>Aan het begin van iedere ronde krijg je een plaatje te zien, waarop een aantal dieren staat.&nbsp;<br>Bijvoorbeeld:<br><img src="pics/ladybugs.JPG" height="50%"></p><p>Het plaatje verdwijnt na 6 seconden. Dan moet je <b>schatten hoeveel dieren er op het plaatje stonden</b><span style="background-color: initial;"><b>.</b><br><b>Hoe preciezer jouw schatting, hoe meer bonus je kunt verdienen.</b>&nbsp;Dit leggen we straks verder uit.</span></p></div>
        ...
        function checkFail() {} function toNextPage2() {
            if (loopEnd==326671) { showNext('wait326671.php?session_index=<?php echo $_SESSION[sessionID];?>',326672,326671);}
            else {showNext('stage326672.php?session_index=<?php echo $_SESSION[sessionID];?>',326672,326671);}
