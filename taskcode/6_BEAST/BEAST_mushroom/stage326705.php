<html>
        ...
        <link href="<?php echo PATH;?>basis/css/grid.css" rel="stylesheet" type="text/css"  /><title>instructions R0</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage326671.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait326705.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
        ...
        <div class="col-sm-12" id="wrap1" style="display: none;"><div class="btnbox2 paddlr" style="text-align: center"><h3>Welkom bij het dierenspel!&nbsp;</h3><p><span style="background-color: initial;">Tijdens deze taak kun je een bonus verdienen. De hoogte van de bonus hangt af van je antwoorden.</span><span style="background-color: initial;">&nbsp;&nbsp;<br>Het doel van deze taak is om <b>zoveel mogelijk bonus te verdienen.</b></span></p><p><span style="background-color: initial;">Klik hieronder om door te gaan naar de instructies.&nbsp;&nbsp;<br></span><span style="background-color: initial;">Lees deze instructies goed door!</span></p><p></p></div>
        ...
        function checkFail() {} function toNextPage2() {
            if (loopEnd==326705) { showNext('wait326705.php?session_index=<?php echo $_SESSION[sessionID];?>',326671,326705);}
            else {showNext('stage326671.php?session_index=<?php echo $_SESSION[sessionID];?>',326671,326705);}
